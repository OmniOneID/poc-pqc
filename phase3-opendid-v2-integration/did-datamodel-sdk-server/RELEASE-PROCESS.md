...
3. **Publishing the Integrated Release**  
   ...
   | ------------------ | --------------- | --------------------------- | --------------------------- |
   | did-datamodel-sdk-server         | V1.0.1          | [Changelog](https://github.com/OmniOneID/did-datamodel-sdk-server/blob/main/CHANGELOG.md) |
   | ..                 | ..              | ..                           |
