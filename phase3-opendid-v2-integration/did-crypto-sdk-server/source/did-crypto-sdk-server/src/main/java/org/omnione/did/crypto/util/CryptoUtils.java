...
import org.omnione.did.crypto.generator.MlDsaKeyPairGenerator; // forten -
...
public class CryptoUtils {
    ...
    private static final MlDsaKeyPairGenerator mlDsaKeyPairGenerator = new MlDsaKeyPairGenerator(); // forten -
  ...
  public static KeyPairInterface generateKeyPair(DidKeyType didKeyType) throws CryptoException{
    ...
    else if (DidKeyType.ML_DSA_44_VERIFICATION_KEY_2024 == didKeyType) { // forten -
