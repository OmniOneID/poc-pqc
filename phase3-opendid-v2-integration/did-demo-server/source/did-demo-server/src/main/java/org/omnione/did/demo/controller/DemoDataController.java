...
public class DemoDataController {
    ...
    @RequestMapping(value = "/api/register-holder-to-issuer", method = RequestMethod.POST)
    @ResponseBody
    public void registerHolderToIssuer(@RequestBody SaveUserInfoReqDto request) {
        demoService.registerHolderToIssuer(request);
    }
