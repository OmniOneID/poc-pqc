...
public class SignatureHelper extends AbstractSignatureHelper {
	@Override
	public KeyCorrectnessProof keyProof(CredentialPrimaryKeyPair credentialPrimaryKeyPair) throws ZkpException {
        return SignatureUtils.generateKeyProof(credentialPrimaryKeyPair);
    }
	@Override
	public PrimaryCredentialSignature sign(String proverDid, CredentialPrimaryKeyPair credentialKeyPair, CredentialValues
			credentialValues, BlindedCredentialSecrets blindMs) throws ZkpException  {
        return SignatureUtils.generateSignature(proverDid, credentialKeyPair, credentialValues, blindMs);
    }
	@Override
	public SignatureCorrectnessProof addProof(CredentialSignature credentialSignature, CredentialPrimaryKeyPair credentialKeyPair, BigInteger nonce) throws ZkpException {
        return SignatureUtils.generateSignatureProof(credentialSignature, credentialKeyPair, nonce);
    }
