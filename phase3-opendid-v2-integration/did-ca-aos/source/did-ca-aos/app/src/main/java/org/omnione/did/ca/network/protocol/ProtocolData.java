...
public class ProtocolData extends BaseModel {
    ...
    // PQC: ML-KEM-768 임시 개인키 (PKCS#8 encoded). ML-KEM 사용 시에만 설정
    private byte[] kemPrivateKey;
    ...
    private String pin;
    private long serverRoundTripNs;
    ...
    public byte[] getKemPrivateKey() {
        return kemPrivateKey;
    }

    public void setKemPrivateKey(byte[] kemPrivateKey) {
    ...
    public long getServerRoundTripNs() {
        return serverRoundTripNs;
    }

    public void resetServerRoundTripNs() {
        this.serverRoundTripNs = 0L;
    }

    public void addServerRoundTripNs(long elapsedNs) {
        if (elapsedNs > 0L) {
            this.serverRoundTripNs += elapsedNs;
        }
    }
