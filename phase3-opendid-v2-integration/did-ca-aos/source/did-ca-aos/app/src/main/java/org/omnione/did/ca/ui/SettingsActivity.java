        ...
        binding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 2) {
                    ...
                    finish();
                } else if (perfTestIndex != -1 && i == perfTestIndex) {
                    startActivity(new Intent(SettingsActivity.this, AutoTestActivity.class));
                }
//                else if (i == 4) {
...
//        adapter.addItem("DID Document Restore","");
        if (BuildConfig.SHOW_PERF_TEST) {
            adapter.addItem("PQC 성능 테스트", "PQC vs Classic 알고리즘 성능 측정");
            perfTestIndex = adapter.getCount() - 1;
        } else {
            perfTestIndex = -1;
        }
