...
public class Config {
    ...
    // PQC: Key algorithm for signing keys — "MlDsa44" for PQC, "Secp256r1" for classical
    // final 제거: AutoTestActivity에서 런타임 알고리즘 선택을 위해 변경 가능하게 함
    public static String KEY_ALGORITHM = "MlDsa44";
