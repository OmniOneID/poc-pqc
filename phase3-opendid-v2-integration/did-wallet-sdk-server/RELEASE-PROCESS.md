...
3. **Publishing the Integrated Release**  
   ...
   | ------------------ | --------------- | --------------------------- | --------------------------- |
   | did-wallet-sdk-server         | V1.0.1          | [Changelog](https://github.com/OmniOneID/did-wallet-sdk-server/blob/main/CHANGELOG.md) |
   | ..                 | ..              | ..                           |
