...
| Item | ECDH | ML-KEM-768 | Ratio | Note |
|------|------|------------|-------|------|
| Request Size | 501 B | 5,128 B | **10.2x** | Includes ML-KEM public key + ML-DSA signature |
| Response Size | 402 B | 4,869 B | **12.1x** | Includes ciphertext + ML-DSA signature |
| Total Protocol | 180.3 ms | 69.8 ms | **0.4x** | ML-KEM is about 2.6x faster |
