...
| Item | Secp256r1 | ML-DSA-44 | Ratio | Note |
|------|-----------|-----------|-------|------|
| Public Key Size | 33 B | 1,334 B | **40.4x** | Raw bytes after Multibase decoding |
| DID Doc Size | 630 B | 4,098 B | **6.5x** | About 6.5x larger when including two public keys |
| Key Gen (x2) | 331.1 ms | 46.4 ms | **0.1x** | ML-DSA-44 is about 7x faster |
