...
public abstract class AbstractSignatureHelper {
	...
	public DidKeyType convertDidKeyType(String keyAlgorithm) throws WalletException {
        ...
        } else if (keyAlgorithm.equals(KeyAlgorithmType.ML_DSA_44.getRawValue())) { // forten - PQC
            return DidKeyType.ML_DSA_44_VERIFICATION_KEY_2024; // forten - crypto SDK의 PQC DidKeyType 사용
        } else {
