...
public class ProofRequestProfile implements ProofContainer {
    @SerializedName("id")
    @Expose
    private String id;
    ...
    @Expose
    private org.omnione.did.sdk.datamodel.profile.ProofRequestProfile.Profile profile;
    ...
    public static class ProfileFilter {
        private List<org.omnione.did.sdk.datamodel.profile.VerifyProfile.CredentialSchema> credentialSchemas;

        public List<org.omnione.did.sdk.datamodel.profile.VerifyProfile.CredentialSchema> getCredentialSchemas() {
            return credentialSchemas;
        }

        public void setCredentialSchemas(List<org.omnione.did.sdk.datamodel.profile.VerifyProfile.CredentialSchema> credentialSchemas) {
    ...
    public org.omnione.did.sdk.datamodel.profile.ProofRequestProfile.Profile getProfile() {
        return profile;
    }

    public void setProfile(org.omnione.did.sdk.datamodel.profile.ProofRequestProfile.Profile profile) {
    ...
    public void fromJson(String val) {
        Gson gson = new Gson();
        org.omnione.did.sdk.datamodel.profile.ProofRequestProfile obj = gson.fromJson(val, org.omnione.did.sdk.datamodel.profile.ProofRequestProfile.class);
