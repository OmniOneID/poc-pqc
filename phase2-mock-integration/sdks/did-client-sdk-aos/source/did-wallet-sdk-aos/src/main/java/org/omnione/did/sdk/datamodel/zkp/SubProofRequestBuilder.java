...
public class SubProofRequestBuilder {
    ...
    public SubProofRequestBuilder addRevealedAttr(HashSet<String> requestedAttributes) {
    ...
    public SubProofRequestBuilder addPredicateAttr(HashSet<PredicateInfo> requestedPredicates) {
