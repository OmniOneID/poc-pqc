...
public class P132ResponseVo extends BaseResponseVo {
    ...
    private AccMlKem accMlKem; // Option 1: server-encap ciphertext + metadata for ML-KEM path
    ...
    public AccMlKem getAccMlKem() {
        return accMlKem;
    }

    public void setAccMlKem(AccMlKem accMlKem) {
        this.accMlKem = accMlKem;
    }
}
