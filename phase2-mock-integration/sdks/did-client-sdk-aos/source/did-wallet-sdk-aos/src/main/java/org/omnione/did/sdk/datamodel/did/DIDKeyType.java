...
public class DIDKeyType {
    public enum DID_KEY_TYPE implements StringEnum {
        ...
        mlDsa44VerificationKey2024("MlDsa44VerificationKey2024"),
        mlKem768AgreementKey2024("MlKem768AgreementKey2024");
        ...
        public String toString() {
            switch (this) {
                ...
                case mlDsa44VerificationKey2024:
                    return "MlDsa44VerificationKey2024";
                case mlKem768AgreementKey2024:
                    return "MlKem768AgreementKey2024";
                default:
                    return "Unknown";
            }
        }
        ...
        public static DID_KEY_TYPE convertFrom(AlgorithmType.ALGORITHM_TYPE type){
            switch (type) {
                ...
                case ML_DSA_44:
                    return DID_KEY_TYPE.mlDsa44VerificationKey2024;
                case ML_KEM_768:
                    return DID_KEY_TYPE.mlKem768AgreementKey2024;
                default:
        ...
        public static AlgorithmType.ALGORITHM_TYPE convertTo(DID_KEY_TYPE type){
            switch (type) {
                ...
                case mlKem768AgreementKey2024:
                    return AlgorithmType.ALGORITHM_TYPE.ML_KEM_768;
                default:
                    throw new RuntimeException();
            }
        }
